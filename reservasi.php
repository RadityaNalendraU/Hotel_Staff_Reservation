...
<div class="max-w-md mx-auto bg-white p-6 rounded-lg shadow-md">
    ...
    <input id="room-number" type="number" class="w-full p-2 border rounded-md" placeholder="Masukkan nomor kamar">
...
<script>
    function searchPhone() {
        ...
        let registeredPhones = ["08123456789", "08234567890"]; // Contoh database nomor telepon
