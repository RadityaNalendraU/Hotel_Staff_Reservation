    ...
    <div class="flex justify-center items-center min-h-screen">
        <div class="bg-white p-8 rounded shadow-md w-full max-w-md">
            ...
            <form>
                ...
                <div class="mb-4">
                    <label class="block text-gray-700 text-sm font-bold mb-2" for="nomor-telepon">
                        Nomor Telepon
                    </label>
                    <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="nomor-telepon" type="text" placeholder="Nomor Telepon">
                </div>
                <div class="mb-4">
